(() => {
  ...
  function canonical(x={}){
    ...
    return{
      ...
      support:{
        ...
        rehab:String(x.support?.rehab||"off"),decon:String(x.support?.decon||"off"),sector:String(x.support?.sector||""),
  ...
  function fillSupport(x={}){for(const [id,k] of [["vehicleUsageSupportOfficer","officer"],["vehicleUsageSupportMission","mission"],["vehicleUsageSupportLighting","lighting"],["vehicleUsageSupportVentilation","ventilation"],["vehicleUsageSupportFullBottles","fullBottles"],["vehicleUsageSupportEmptyBottles","emptyBottles"],["vehicleUsageSupportRehab","rehab"],["vehicleUsageSupportDecon","decon"],["vehicleUsageSupportSector","sector"],["vehicleUsageSupportEquipment","equipment"],["vehicleUsageSupportNotes","notes"]])$(id).value=x[k]??""}
  function readSupport(){return{officer:$("vehicleUsageSupportOfficer").value.trim(),mission:$("vehicleUsageSupportMission").value,lighting:$("vehicleUsageSupportLighting").value,ventilation:$("vehicleUsageSupportVentilation").value,fullBottles:$("vehicleUsageSupportFullBottles").value,emptyBottles:$("vehicleUsageSupportEmptyBottles").value,rehab:$("vehicleUsageSupportRehab").value,decon:$("vehicleUsageSupportDecon").value,sector:$("vehicleUsageSupportSector").value,equipment:$("vehicleUsageSupportEquipment").value.trim(),notes:$("vehicleUsageSupportNotes").value.trim()}}
